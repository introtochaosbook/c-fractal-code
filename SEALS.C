...
/* initialize IFS data array */
	...
	d[0][0]=-0.5;  d[0][2]=0;  d[0][2]=0;  d[0][3]=0.5;  d[0][4]=0; d[0][5]=0;
	d[1][0]=-0.5;  d[1][2]=0;  d[1][2]=0;  d[1][3]=0.5;  d[1][4]=2; d[1][5]=0;
	d[2][0]=-0.4;  d[2][2]=0;  d[2][2]=1;  d[2][3]=0.4;  d[2][4]=0; d[2][5]=1;
	d[3][0]=-0.5;  d[3][2]=0;  d[3][2]=0;  d[3][3]=0.5;  d[3][4]=2; d[3][5]=1;
	...
	for (i = 1; i <= 32000; i++)
	  {
		  ...
		  if (i > 10)                       /* skip first 10 iterations */
				 putpixel(MaxY*x/2,MaxY-MaxY*y/2,WHITE);
	  }                               /* scale for screen */
	  getch();
	  closegraph();
}
